          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-8">
            <Card className="h-[320px] p-0 flex flex-col col-span-2 md:col-span-3">
              ...
              <div
                ...
                ref={constraintRef} /* To add constraint */
              >
                {hobbies.map((hobby) => (
                  <motion.div
                    key={hobby.title}
                    className="inline-flex items-center gap-2 py-1.5 px-6 outline outline-2 outline-black/10 rounded-full absolute bg-white" /* Dragable labels */
                    style={{
                      left: hobby.left,
                      top: hobby.top,
                    }}
